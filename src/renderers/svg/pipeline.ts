 ...
 */
export function renderPipelineSvg(systemName: string, stages: string[], color: string): string {
	...
	const defs = [glowFilterDefs(usedColors), arrowMarkerDef(color, "pipe-arrow")].join("\n");

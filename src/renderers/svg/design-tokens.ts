...
export function wrapText(text: string, maxWidth: number, fontSize: number, weight: "normal" | "bold" = "normal"): string[] {
...
function findLastHyphenThatFits(word: string, maxWidth: number, fontSize: number, weight: "normal" | "bold"): number {
  let best = -1;
...
export function fitText(text: string, maxWidth: number, maxLines: number, fontSize: number, weight: "normal" | "bold" = "normal"): string[] {
...
export function shrinkToFit(text: string, maxWidth: number, baseSize: number, minSize: number, weight: "normal" | "bold" = "normal"): number {
  let size = baseSize;
